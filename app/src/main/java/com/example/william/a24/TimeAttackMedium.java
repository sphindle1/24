...
public class TimeAttackMedium extends SingleMode {
    long timeCount;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_time_attack_medium);TextView highScore = (TextView) findViewById(R.id.highScore);
        sharedPref = TimeAttackMedium.this.getPreferences(Context.MODE_PRIVATE);
            ...
            public void onFinish() {
                ...
                restart.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        /*Intent intent = new Intent(TimeAttackMedium.this, TimeAttackEasy.class);
